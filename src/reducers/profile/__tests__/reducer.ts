...
describe('profile reducer', () => {
  ...
  it('should handle SET_PROFILE', () => {
    ...
    testReducer(STATE_WITH_EMPTY_PROFILE, SET_PROFILE_EMPTY_ACTION, {
      ...STATE_WITH_PROFILE,
    });
  });
  ...
  it('should handle SET_FETCHING_STATUS', () => {
    ...
    testReducer(INITIAL_STATE, SET_FETCHING_STATUS_FALSE_ACTION, {
      ...STATE_WITH_FETCHING_STATUS_TRUE,
    });
  });
  ...
  it('should handle SET_FETCHING_PHOTO', () => {
    ...
    testReducer(INITIAL_STATE, SET_FETCHING_PHOTO_FALSE_ACTION, {
      ...STATE_WITH_FETCHING_PHOTO_TRUE,
    });
  });

  it('should handle SET_UPDATING', () => {
    testReducer(STATE_WITH_UPDATING_TRUE, SET_UPDATING_TRUE_ACTION, {
      ...INITIAL_STATE,
    });
    testReducer(INITIAL_STATE, SET_UPDATING_FALSE_ACTION, {
      ...STATE_WITH_UPDATING_TRUE,
    });
  });

  it('should handle SET_FOLLOWED', () => {
    testReducer(STATE_WITH_FOLLOWED_TRUE, SET_FOLLOWED_TRUE_ACTION, {
      ...INITIAL_STATE,
    });
    testReducer(INITIAL_STATE, SET_FOLLOWED_FALSE_ACTION, {
      ...STATE_WITH_FOLLOWED_TRUE,
    });
  });

  it('should handle SET_FOLLOWING', () => {
    testReducer(STATE_WITH_FOLLOWING_TRUE, SET_FOLLOWING_TRUE_ACTION, {
      ...INITIAL_STATE,
    });
    testReducer(INITIAL_STATE, SET_FOLLOWING_FALSE_ACTION, {
      ...STATE_WITH_FOLLOWING_TRUE,
    });
  });

  it('should handle SET_PHOTO', () => {
    testReducer(STATE_WITH_PROFILE_PHOTOS, SET_PHOTO_ACTION, {
      ...INITIAL_STATE,
    });
  });
});

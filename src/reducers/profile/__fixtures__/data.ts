...
export const PHOTO: File = new File(['image_file'], 'image_file.png', {type: 'image/png'});
...
export const SET_PHOTO_ACTION: ProfileAction = {type: SET_PHOTO, payload: {photos: {...PHOTOS}}};
export const SET_FETCHING_TRUE_ACTION: ProfileAction = {type: SET_FETCHING, payload: {fetching: true}};
export const SET_FETCHING_FALSE_ACTION: ProfileAction = {type: SET_FETCHING, payload: {fetching: false}};
...
export const SET_FETCHING_PHOTO_TRUE_ACTION: ProfileAction = {type: SET_FETCHING_PHOTO, payload: {fetchingPhoto: true}};
export const SET_FETCHING_PHOTO_FALSE_ACTION: ProfileAction = {
  type: SET_FETCHING_PHOTO,
  payload: {fetchingPhoto: false}
};
export const SET_UPDATING_TRUE_ACTION: ProfileAction = {type: SET_UPDATING, payload: {updating: true}};
export const SET_UPDATING_FALSE_ACTION: ProfileAction = {type: SET_UPDATING, payload: {updating: false}};
export const SET_FOLLOWED_TRUE_ACTION: ProfileAction = {type: SET_FOLLOWED, payload: {followed: true}};
export const SET_FOLLOWED_FALSE_ACTION: ProfileAction = {type: SET_FOLLOWED, payload: {followed: false}};
export const SET_FOLLOWING_TRUE_ACTION: ProfileAction = {type: SET_FOLLOWING, payload: {following: true}};
export const SET_FOLLOWING_FALSE_ACTION: ProfileAction = {type: SET_FOLLOWING, payload: {following: false}};

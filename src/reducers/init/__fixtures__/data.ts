...
export const STATE_WITH_INITIALIZED_TRUE: InitState = {
  ...INITIAL_STATE,
  initialized: true,
};
...
export const EMPTY_ACTION = {} as InitAction;
export const SET_INITIALIZED_TRUE_ACTION: InitAction = {
  type: SET_INITIALIZED,
  payload: {initialized: true},
};
export const SET_INITIALIZED_FALSE_ACTION: InitAction = {
  type: SET_INITIALIZED,

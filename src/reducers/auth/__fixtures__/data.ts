...
export const STATE_WITH_FETCHING_TRUE: AuthState = {
  ...INITIAL_STATE,
  fetching: true,
};
export const STATE_WITH_CURRENT_USER: AuthState = {
  ...INITIAL_STATE,
  userId: USER_ID,
  email: EMAIL,
  login: LOGIN,
};
export const STATE_WITH_CAPTCHA: AuthState = {
  ...INITIAL_STATE,
  captcha: CAPTCHA_URL,
};
export const STATE_WITH_UPDATING_TRUE: AuthState = {
  ...INITIAL_STATE,
  updating: true,
};
...
export const SUCCESS_GET_CAPTCHA_RESPONSE: GetCaptchaResponse = {
  url: CAPTCHA_URL,
};
...
export const ERROR_LOGIN_RESPONSE: LoginResponse = {
  resultCode: ResultCode.ERROR,
  messages: [ERROR_MESSAGE],
};
export const SUCCESS_LOGOUT_RESPONSE: LogoutResponse = {
  data: {},
  resultCode: ResultCode.SUCCESS,
  messages: [],
};
...
export const SET_FETCHING_TRUE_ACTION: AuthAction = {
  type: SET_FETCHING,
  payload: {fetching: true},
};
export const SET_FETCHING_FALSE_ACTION: AuthAction = {
  type: SET_FETCHING,
  payload: {fetching: false},
};
export const SET_UPDATING_TRUE_ACTION: AuthAction = {
  type: SET_UPDATING,
  payload: {updating: true},
};
export const SET_UPDATING_FALSE_ACTION: AuthAction = {
  type: SET_UPDATING,
...
export const SET_CAPTCHA_ACTION: AuthAction = {
  type: SET_CAPTCHA,
  payload: {captcha: CAPTCHA_URL},
};
export const SET_CAPTCHA_EMPTY_ACTION: AuthAction = {
  type: SET_CAPTCHA,
  payload: {captcha: null},
};

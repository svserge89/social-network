...
export const required: FieldValidator<string> = (value) => value ? undefined : 'Required';
...
export const compose = (validators?: FieldValidator<string> | FieldValidator<string>[])
  : FieldValidator<string> | undefined => {
  if (validators instanceof Array) {
    return (value) => validators.reduce(
      (error, validator: FieldValidator<string>) => error || validator(value, {}),
      undefined
    );
  }
